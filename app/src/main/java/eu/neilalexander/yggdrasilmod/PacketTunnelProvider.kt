...
import eu.neilalexander.yggdrasilmod.YggStateReceiver.Companion.YGG_STATE_INTENT
...
open class PacketTunnelProvider: VpnService() {
    companion object {
        const val STATE_INTENT = "eu.neilalexander.yggdrasilmod.PacketTunnelProvider.STATE_MESSAGE"

        const val ACTION_START = "eu.neilalexander.yggdrasilmod.PacketTunnelProvider.START"
        const val ACTION_STOP = "eu.neilalexander.yggdrasilmod.PacketTunnelProvider.STOP"
        const val ACTION_TOGGLE = "eu.neilalexander.yggdrasilmod.PacketTunnelProvider.TOGGLE"
        const val ACTION_CONNECT = "eu.neilalexander.yggdrasilmod.PacketTunnelProvider.CONNECT"
    }
